...
//Actual implementation of inputting the name
void inputName(Customer &customer, string info){
        customer.name = inputString(info + " Name");
}

//Actual implementation of inputing the age
...
//Update the name of a specific customer
...
//Update the age of a specific customer
...
//Update the mobile number of a specific customer
...
//Add a single flight to the customer's list
void add1Flight(Customer &customer){
	...
	do{
		...
		newFlight.number = inputInt("flight number"); //input flight number
		
		newFlight.destination = inputString("Flight destination");//input flight destination
	...
	//add the flight to the customer's list
    customer.flights[customer.flightCounter] = newFlight;
    customer.flightCounter++;// Increment the flight counter
...
//Asks the user if he want to add more flights or not
bool addMore(){
	int choice;
	do{
...
//Display details of a single flight
...
void displayCustomerFlights(Customer customer) {
    ...
    for(int i = 0; i < customer.flightCounter; i++) {
        ...
        //call the function to display individual flight details
